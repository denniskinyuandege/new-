...
If the response is not received in this interval, the message is marked as unanswered and the agent may start a
new synchronization session at the defined interval.
